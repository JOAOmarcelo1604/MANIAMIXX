...
class ClientesHeaderList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $endereco->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        ...
        $action_onEdit = new TDataGridAction(array('ClientesForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ClientesHeaderList', 'onDelete'));
        ...
        $tr->add($td_telefone);
        $td_endereco = TElement::tag('td', $endereco);
        $tr->add($td_endereco);
        ...
        $this->datagrid_form->addField($endereco);
        ...
        $panel = new TPanelGroup("Listagem de cliente");
        ...
        $button_cadastrar->setAction(new TAction(['ClientesForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ClientesHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ClientesHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ClientesHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['ClientesHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Estoque","Cliente"]));
        }
