...
class ProdutoQRCode extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Etiqueta QRcode de Produtos");
        ...
        $container->add(TBreadCrumb::create(["Estoque","Etiqueta QRcode de Produtos"]));
    ...
    public function onGenerate($param)
    {
        try 
        {
            ...
            $properties['topMargin']     = 12; // Top margin
            $properties['labelWidth']    = 63; // Label width in mm
            $properties['labelHeight']   = 28; // Label height in mm
            $properties['spaceBetween']  = 5;  // Space between labels
            $properties['rowsPerPage']   = 7;  // Label rows per page
            $properties['colsPerPage']   = 3;  // Label cols per page
            $properties['fontSize']      = 14; // Text font size
            $properties['barcodeHeight'] = 16; // Barcode Height
            $properties['imageMargin']   = 4;
