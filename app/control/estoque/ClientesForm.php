...
class ClientesForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Email :", null, '14px', null)],[$email],[new TLabel("Telefone:", null, '14px', null)],[$telefone]);
        $row3 = $this->form->addFields([new TLabel("Endereco:", null, '14px', null)],[$endereco],[],[]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['ClientesHeaderList', 'onShow']), 'fas:arrow-left #000000');
